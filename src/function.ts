...
// 매개변수에 기본값 지정 가능
function greet(name:  string, word: string = "hello"): void{
...
const fun2 = function(n: number):void {
    console.log(n*n);
};
fun2(5); // 25
...
const fun3 = (n: number):void => console.log(n*n); // 반환값이 없을때
const fun4 = (n: number) => n*n; // => 우측값이 반환값
fun3(10); // 100
let result = fun4(10);
